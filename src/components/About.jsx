            ...
            <div className="container py-5 my-5">
                <div className="row">
                    ...
                    <div className="col-md-6 d-flex justify-content-center">
                        <img src="https://img.freepik.com/free-vector/about-us-concept-illustration_114360-669.jpg?w=996&t=st=1684170396~exp=1684170996~hmac=1a393e89a66d8b5723bbf64f8bfe6b800e1134a76880ae2fb6494e41590f14ca" alt="About Us" height="100%" width="100%" />
                    </div>
                </div>
            </div>
        </div>
